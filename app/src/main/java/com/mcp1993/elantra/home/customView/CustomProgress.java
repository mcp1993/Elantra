package com.mcp1993.elantra.home.customView;
...
public class CustomProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typeArray.getColor(R.styleable.CustomProgress_circleColor, getResources().getColor(R.color.bg_text_green));

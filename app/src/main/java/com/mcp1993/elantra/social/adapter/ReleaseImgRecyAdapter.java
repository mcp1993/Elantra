...
public class ReleaseImgRecyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReleaseImgRecyAdapter(List<String> paths, Context context) {
        this.paths = paths;
...
//                   .into( ((ItemViewFooterHolder)holder).item_img_add);
            ...
            ((ItemViewFooterHolder)holder).item_img_add.setLayoutParams(layoutParams);
            ((ItemViewFooterHolder)holder).item_img_add.setImageResource(R.mipmap.bracelet_add);
    ...
    class ItemViewFooterHolder extends RecyclerView.ViewHolder{
        ...
        public ItemViewFooterHolder(View itemView) {
            ...
            re_select = (RelativeLayout) itemView.findViewById(R.id.re_select);
        }
    }

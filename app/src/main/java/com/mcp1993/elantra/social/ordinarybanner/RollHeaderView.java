package com.mcp1993.elantra.social.ordinarybanner;
...
//        vParams.height = (int) (DisplayUtil.getMobileHeight(mContext) * 0.4);
        vParams.height = (int) (DisplayUtil.getMobileWidth(mContext) / 3);
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.sprite_nav_3);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.sprite_nav1_3);
                }
                //设置点的间距
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            Picasso.with(mContext).load(mUrlList.get(position % mUrlList.size()))
                    .resize(DisplayUtil.getMobileWidth(mContext) ,DisplayUtil.getMobileWidth(mContext) / 3)
                    .centerCrop()
                    .into(iv);
...
//    return iv;
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.sprite_nav1_3);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.sprite_nav_3);
